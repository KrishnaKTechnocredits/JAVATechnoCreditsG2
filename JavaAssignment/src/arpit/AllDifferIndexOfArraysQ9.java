...
public class AllDifferIndexOfArraysQ9 {
		...
		if (element1.length != element2.length) {
			...
			for (int index = 0; index < element1.length; index++) {
				if (element1[index] != element2[index]) {
					...
					// Display the result
					System.out.println("value of Arrays is not matching at index is: " + "index " + index);
	...
	public static void main(String[] args) {
		...
		AllDifferIndexOfArraysQ9 checkAllIndex = new AllDifferIndexOfArraysQ9();

		// To call the inputForArray1 method and store result in "a1"
		int[] a1 = checkAllIndex.inputForArray1();

		// To call the inputForArray1 method and store result in "a2"
		int[] a2 = checkAllIndex.inputForArray2();

		// To call the arraysDifferAtFirstIndex method and provide input to that
		// method
		checkAllIndex.arraysDifferAtFirstIndex(a1, a2);
