/*Below program is for finding all differing index from given arrays 
...
public class PurvaAssignment2Q9 {
	public static void main(String[] args) {
		...
		PurvaAssignment2Q9 obj1 = new PurvaAssignment2Q9();
		System.out.print("\n" + "i/p :-" + "\t" + "arr1: ");
	...
	/*
	 * Below lines of codes check is all values in both arrays are same. If yes
	 * returns both arrays are having same value msg, else it will compare
	 * values and print first differing index
	 */
	 ...
	 * and it will print that index. It will also check maximum value of numbers
	 * from that index.
	 */
